      ...
      <div class="container">
        ...
        <div class="steps">
          <div class="step">
            ...
            <p>Complete our online application form with required documents</p>
          </div>
          
          <div class="step">
            <div class="step-number">2</div>
            <h3>Assessment</h3>
            <p>Participate in our entrance assessment and interview</p>
          </div>
          ...
          <div class="step">
            ...
            <h3>Enrollment</h3>
            <p>Receive your decision and complete enrollment</p>
          </div>
        </div>
      </div>
    </section>
